...
能区分托管与自托管、热钱包与冷钱包、私钥与助记词；完成离线备份方案和钓鱼识别清单；通过签名前安全门后，在不暴露秘密的隔离环境中完成练习账户、离线交易确认与恢复演练。公共测试网收发为可选加练，不是通关前提。详细标准见[第三阶段计划](stage-03-wallet-security.md)的“最终退出标准”。
